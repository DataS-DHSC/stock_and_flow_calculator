        ...
        tabsetPanel(
            tabPanel('Calculator',
                     ...
                     numericInput(inputId = 'ga_beds', 
                                  ...
                                  step = 10),
                     h2("Ouputs:"),
                     strong(textOutput(outputId = 'patient_stock')),
                     strong(textOutput(outputId = 'ctr_stock')),
                     strong(textOutput(outputId = 'nctr_stock')),
                     strong(textOutput(outputId = 'total_admissions')),
                     strong(textOutput(outputId = 'avg_los')),
                     strong(textOutput(outputId = 'nctr_per_bed'))
            ),
            tabPanel('Length of delay calculator',
                     ...
                     #              max = 1, 
                     #              step = 0.01),
                     # numericInput(inputId = 'post_DRD_lod', 
                     #              label = 'Select average post-DRD length of delay (all patients):', 
                     #              value = 3, 
                     #              min = 0, 
                     #              max = 30, 
                     #              step = 1),
                     # numericInput(inputId = 'bed_occ_2', 
                     #              label = 'Select bed occupancy (%):', 
                     #              value = 90, 
                     #              min = 50, 
                     #              max = 100, 
                     #              step = 1),
                     # numericInput(inputId = 'ga_beds_2', 
                     #              label = 'Select G&A beds:', 
                     #              value = 100, 
                     #              min = 50, 
                     #              max = 2000, 
